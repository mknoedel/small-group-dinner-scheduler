...
const michael: UserResponse = {
  ...
  firstName: 'Michael',
  lastName: 'Knoedel',
  email: 'mknoedel@gmail.com'
} 
const molly: UserResponse = {
  id: '2',
  firstName: 'Molly',
  lastName: 'Cowan',
  email: 'cowan.molly@gmail.com'
}
const taegan: UserResponse = {
  id: '3',
  firstName: 'Taegan',
  lastName: 'Williams',
  email: 'taegan.williams@gmail.com'
}
const zach: UserResponse = {
  id: '4',
  firstName: 'Zach',
  lastName: 'Lipps',
  email: 'zach.lipps@gmail.com'
}
const gautam: UserResponse = {
  id: '5',
  firstName: 'Gautam',
  lastName: 'Chebrolu',
  email: 'gautam.chebrolu@gmail.com'
}
const rachel: UserResponse = {
  id: '6',
  firstName: 'Rachel',
  lastName: 'Wiener',
  email: 'rachel.wiener@gmail.com'
}
...
const Home: NextPage = () => {
  return (
    <Stack spacing={2} padding={2}>
      <Stack>
        {dinners.map((dinner) => <div key={dinner.id}>{JSON.stringify(dinner)}</div>)}
      </Stack>
